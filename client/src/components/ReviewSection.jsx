        ...
        <form onSubmit={handleReviewSubmit} className="space-y-2.5 bg-white p-3.5 rounded-xl border border-slate-200 shadow-xs">
          ...
          <div className="flex items-center justify-between text-xs">
            ...
            <button
              ...
              className="px-4 py-1.5 rounded-lg bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-300 text-white font-semibold shadow-xs transition-colors cursor-pointer disabled:cursor-not-allowed"
            >
          ...
          {reviews.map((review) => {
            ...
            return (
              ...
              >
                  ...
                  <div className="space-y-2 pl-8">
                    ...
                    <div className="flex items-center gap-2 justify-end">
                      <button
                        ...
                        className="px-2.5 py-1 text-xs text-slate-600 hover:text-slate-800 rounded-md"
                      >
                        Cancel
                      </button>
                      <button
                        ...
                        className="px-3 py-1 text-xs bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-700 disabled:bg-indigo-300"
                      >
                ...
                <div className="flex items-center gap-4 pl-8 pt-1 text-xs">
                  {/* Helpful Vote Button */}
                  <button
                    ...
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="px-3 py-1 bg-indigo-600 text-white font-semibold rounded-lg hover:bg-indigo-700 disabled:bg-indigo-300"
                        >
                          {submittingReplyId === review._id ? 'Posting...' : 'Submit Reply'}
                        </button>
                      </div>
                    </div>
                  </div>
