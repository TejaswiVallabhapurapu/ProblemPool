...
const Profile = () => {
  ...
  // Handle interest badge click/toggle in edit modal
  ...
  if (!isAuthenticated && isViewingSelf) {
    return (
      <div className="max-w-md mx-auto px-4 py-20 text-center">
        <div className="w-16 h-16 rounded-2xl bg-[#161616] text-white flex items-center justify-center mx-auto mb-4 text-2xl border border-white/10">
          🔒
        </div>
  ...
  if (error || !profileData) {
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center">
        <div className="w-12 h-12 rounded-full bg-rose-950/40 text-rose-400 flex items-center justify-center mx-auto mb-4 border border-rose-500/20">
  ...
  return (
    <div className="relative min-h-screen">
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        {/* ========================================================= */}
        {/* 1. PROFILE HEADER CARD (Dark Glass) */}
        {/* ========================================================= */}
          ...
          <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 sm:gap-6">
              ...
              <div className="relative group shrink-0">
                ...
                <div className="absolute -bottom-2 -right-2 bg-[#181818] rounded-xl shadow-xs border border-white/15 px-2 py-0.5 text-xs font-bold flex items-center gap-1">
                  <span>{level.icon}</span>
                  <span className="text-[11px] text-slate-300 hidden sm:inline">{level.name}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap items-center gap-4 text-xs text-slate-400 font-medium">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 hover:text-white transition cursor-pointer font-semibold"
                  >
            ...
            <div className="flex flex-col sm:flex-row lg:flex-col items-start sm:items-center lg:items-end gap-3 w-full lg:w-auto pt-4 lg:pt-0 border-t lg:border-t-0 border-white/10">
              ...
              <div className="bg-[#181818]/90 border border-white/15 rounded-2xl p-3.5 sm:px-5 flex items-center gap-4 shadow-md backdrop-blur-md">
                <div className="w-11 h-11 rounded-xl bg-amber-400/10 border border-amber-400/20 text-amber-400 flex items-center justify-center font-black text-xl">
                  ⭐
                </div>
                <div>
                ...
                {isViewingSelf ? (
                  <>
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl border border-white/10 bg-[#181818] text-slate-400 hover:text-white hover:bg-[#222222] transition cursor-pointer"
                    >
            ...
            <div className="bg-[#141414]/80 backdrop-blur-md rounded-3xl border border-white/10 p-6 sm:p-8 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                ...
                {isViewingSelf && (
                  <button
                    onClick={() => setIsEditModalOpen(true)}
                    className="text-xs font-semibold text-slate-300 hover:text-white inline-flex items-center gap-1 cursor-pointer"
                  >
              ...
              {user.interests && user.interests.length > 0 ? (
                <div className="flex flex-wrap gap-2 pt-2">
                  {user.interests.map((interest) => (
                    <span
                      key={interest}
                      className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-[#1c1c1c] border border-white/10 text-slate-200 text-xs font-semibold shadow-xs hover:border-white/20 transition"
                    >
                ...
                <div className="p-6 bg-[#181818]/60 rounded-2xl border border-dashed border-white/10 text-center">
                  ...
                  {isViewingSelf && (
                    <button
                      onClick={() => setIsEditModalOpen(true)}
                      className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-semibold text-black bg-white hover:bg-slate-200 cursor-pointer transition shadow-xs"
                    >
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                ...
                {level.next && (
                  <div className="text-xs text-slate-300 bg-white/10 border border-white/10 px-3 py-1.5 rounded-xl backdrop-blur-md self-start sm:self-auto font-medium">
                    Next Level at <strong className="text-white">{level.next} ⭐</strong> ({level.next - stats.reputation} pts remaining)
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                {achievements.slice(0, 4).map((badge) => (
                  ...
                  >
                    ...
                    <div className="font-bold text-xs text-white">{badge.title}</div>
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="flex items-center gap-1.5 text-xs text-slate-400">
                          ...
                          <span>•</span>
                          <span className="text-amber-400 font-semibold">⭐ {f.reputation}</span>
                        </div>
                        {f.title && (
        ...
        {currentTab === 'following' && (
          <div className="bg-[#141414]/80 backdrop-blur-md rounded-3xl border border-white/10 p-6 sm:p-8 shadow-sm">
            ...
            {tabLoading ? (
              ...
              <div className="py-12 text-center text-slate-400 text-xs">
                <UserCheck className="w-10 h-10 mx-auto mb-2 text-slate-500" />
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      {act.link && (
                        <Link
                          to={act.link}
                          className="text-white hover:text-slate-300 text-xs font-semibold inline-flex items-center gap-0.5"
                        >
                          <span>View</span>
                          <ChevronRight className="w-3.5 h-3.5" />
                        </Link>
        ...
        {/* ========================================================= */}
        {/* 4. EDIT PROFILE & INTERESTS MODAL (Dark Theme) */}
        {/* ========================================================= */}
        {isEditModalOpen && (
